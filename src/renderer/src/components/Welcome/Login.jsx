  ...
  return (
    <div className="flex flex-col justify-between justify-center w-full h-full items-center mt-10 gap-10 px-24">
      ...
      <form className="w-5/12 min-w-96 flex flex-col justify-between justify-center gap-4">
        ...
        <button className="block h-12 min-w-96 rounded-xl bg-black text-white shadow-lg font-bold hover:bg-neutral-800">
          Log in
        </button>
        <button className="block h-12 min-w-96 rounded-xl shadow-lg font-bold hover:bg-gray-50">
          Join in
        </button>
      </form>
    </div>
